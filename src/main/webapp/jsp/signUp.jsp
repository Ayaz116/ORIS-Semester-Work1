...
<head>
    ...
    <style>
        ...
        .errorMessage {
            color:#b3b3b3; font-size:0.9em; font-weight:normal; margin-bottom:15px;
...
<div class="form-container">
    ...
    <form id="signUpForm" action="${pageContext.request.contextPath}/signUp" method="post">
        ...
        <input id="nickname" name="nickname" type="text" placeholder="Ваш никнейм" required/>
    ...
    <a href="${pageContext.request.contextPath}/signIn">Уже есть аккаунт? Войти</a>
